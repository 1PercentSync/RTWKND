...
[(Top)](https://raytracing.github.io/books/RayTracingInOneWeekend.html#)

[1  Overview](https://raytracing.github.io/books/RayTracingInOneWeekend.html#overview)

[2  Output an Image](https://raytracing.github.io/books/RayTracingInOneWeekend.html#outputanimage)

[2.1  The PPM Image Format](https://raytracing.github.io/books/RayTracingInOneWeekend.html#outputanimage/theppmimageformat)
...
[2.3  Adding a Progress Indicator](https://raytracing.github.io/books/RayTracingInOneWeekend.html#outputanimage/addingaprogressindicator)

[3  The vec3 Class](https://raytracing.github.io/books/RayTracingInOneWeekend.html#thevec3class)

[3.1  Color Utility Functions](https://raytracing.github.io/books/RayTracingInOneWeekend.html#thevec3class/colorutilityfunctions)
...
[4.1  The ray Class](https://raytracing.github.io/books/RayTracingInOneWeekend.html#rays,asimplecamera,andbackground/therayclass)

[4.2  Sending Rays Into the Scene](https://raytracing.github.io/books/RayTracingInOneWeekend.html#rays,asimplecamera,andbackground/sendingraysintothescene)

[5  Adding a Sphere](https://raytracing.github.io/books/RayTracingInOneWeekend.html#addingasphere)

[5.1  Ray-Sphere Intersection](https://raytracing.github.io/books/RayTracingInOneWeekend.html#addingasphere/ray-sphereintersection)

[5.2  Creating Our First Raytraced Image](https://raytracing.github.io/books/RayTracingInOneWeekend.html#addingasphere/creatingourfirstraytracedimage)
...
[6.1  Shading with Surface Normals](https://raytracing.github.io/books/RayTracingInOneWeekend.html#surfacenormalsandmultipleobjects/shadingwithsurfacenormals)

[6.2  Simplifying the Ray-Sphere Intersection Code](https://raytracing.github.io/books/RayTracingInOneWeekend.html#surfacenormalsandmultipleobjects/simplifyingtheray-sphereintersectioncode)

[6.3  An Abstraction for Hittable Objects](https://raytracing.github.io/books/RayTracingInOneWeekend.html#surfacenormalsandmultipleobjects/anabstractionforhittableobjects)

[6.4  Front Faces Versus Back Faces](https://raytracing.github.io/books/RayTracingInOneWeekend.html#surfacenormalsandmultipleobjects/frontfacesversusbackfaces)

[6.5  A List of Hittable Objects](https://raytracing.github.io/books/RayTracingInOneWeekend.html#surfacenormalsandmultipleobjects/alistofhittableobjects)
...
[6.7  Common Constants and Utility Functions](https://raytracing.github.io/books/RayTracingInOneWeekend.html#surfacenormalsandmultipleobjects/commonconstantsandutilityfunctions)

[6.8  An Interval Class](https://raytracing.github.io/books/RayTracingInOneWeekend.html#surfacenormalsandmultipleobjects/anintervalclass)

[7  Moving Camera Code Into Its Own Class](https://raytracing.github.io/books/RayTracingInOneWeekend.html#movingcameracodeintoitsownclass)

[8  Antialiasing](https://raytracing.github.io/books/RayTracingInOneWeekend.html#antialiasing)

[8.1  Some Random Number Utilities](https://raytracing.github.io/books/RayTracingInOneWeekend.html#antialiasing/somerandomnumberutilities)

[8.2  Generating Pixels with Multiple Samples](https://raytracing.github.io/books/RayTracingInOneWeekend.html#antialiasing/generatingpixelswithmultiplesamples)

[9  Diffuse Materials](https://raytracing.github.io/books/RayTracingInOneWeekend.html#diffusematerials)

[9.1  A Simple Diffuse Material](https://raytracing.github.io/books/RayTracingInOneWeekend.html#diffusematerials/asimplediffusematerial)

[9.2  Limiting the Number of Child Rays](https://raytracing.github.io/books/RayTracingInOneWeekend.html#diffusematerials/limitingthenumberofchildrays)

[9.3  Fixing Shadow Acne](https://raytracing.github.io/books/RayTracingInOneWeekend.html#diffusematerials/fixingshadowacne)

[9.4  True Lambertian Reflection](https://raytracing.github.io/books/RayTracingInOneWeekend.html#diffusematerials/truelambertianreflection)

[9.5  Using Gamma Correction for Accurate Color Intensity](https://raytracing.github.io/books/RayTracingInOneWeekend.html#diffusematerials/usinggammacorrectionforaccuratecolorintensity)

[10  Metal](https://raytracing.github.io/books/RayTracingInOneWeekend.html#metal)

[10.1  An Abstract Class for Materials](https://raytracing.github.io/books/RayTracingInOneWeekend.html#metal/anabstractclassformaterials)

[10.2  A Data Structure to Describe Ray-Object Intersections](https://raytracing.github.io/books/RayTracingInOneWeekend.html#metal/adatastructuretodescriberay-objectintersections)

[10.3  Modeling Light Scatter and Reflectance](https://raytracing.github.io/books/RayTracingInOneWeekend.html#metal/modelinglightscatterandreflectance)

[10.4  Mirrored Light Reflection](https://raytracing.github.io/books/RayTracingInOneWeekend.html#metal/mirroredlightreflection)
...
[10.6  Fuzzy Reflection](https://raytracing.github.io/books/RayTracingInOneWeekend.html#metal/fuzzyreflection)

[11  Dielectrics](https://raytracing.github.io/books/RayTracingInOneWeekend.html#dielectrics)

[11.1  Refraction](https://raytracing.github.io/books/RayTracingInOneWeekend.html#dielectrics/refraction)
...
[11.4  Schlick Approximation](https://raytracing.github.io/books/RayTracingInOneWeekend.html#dielectrics/schlickapproximation)

[11.5  Modeling a Hollow Glass Sphere](https://raytracing.github.io/books/RayTracingInOneWeekend.html#dielectrics/modelingahollowglasssphere)

[12  Positionable Camera](https://raytracing.github.io/books/RayTracingInOneWeekend.html#positionablecamera)
...
[13  Defocus Blur](https://raytracing.github.io/books/RayTracingInOneWeekend.html#defocusblur)

[13.1  A Thin Lens Approximation](https://raytracing.github.io/books/RayTracingInOneWeekend.html#defocusblur/athinlensapproximation)
...
[14  Where Next?](https://raytracing.github.io/books/RayTracingInOneWeekend.html#wherenext?)

[14.1  A Final Render](https://raytracing.github.io/books/RayTracingInOneWeekend.html#wherenext?/afinalrender)

[14.2  Next Steps](https://raytracing.github.io/books/RayTracingInOneWeekend.html#wherenext?/nextsteps)

[14.2.1  Book 2: _Ray Tracing: The Next Week_](https://raytracing.github.io/books/RayTracingInOneWeekend.html#wherenext?/nextsteps/book2:raytracing:thenextweek)

[14.2.2  Book 3: _Ray Tracing: The Rest of Your Life_](https://raytracing.github.io/books/RayTracingInOneWeekend.html#wherenext?/nextsteps/book3:raytracing:therestofyourlife)

[14.2.3  Other Directions](https://raytracing.github.io/books/RayTracingInOneWeekend.html#wherenext?/nextsteps/otherdirections)

[15  Acknowledgments](https://raytracing.github.io/books/RayTracingInOneWeekend.html#acknowledgments)

[16  Citing This Book](https://raytracing.github.io/books/RayTracingInOneWeekend.html#citingthisbook)

[16.1  Basic Data](https://raytracing.github.io/books/RayTracingInOneWeekend.html#citingthisbook/basicdata)

[16.2  Snippets](https://raytracing.github.io/books/RayTracingInOneWeekend.html#citingthisbook/snippets)

[16.2.1  Markdown](https://raytracing.github.io/books/RayTracingInOneWeekend.html#citingthisbook/snippets/markdown)

[16.2.2  HTML](https://raytracing.github.io/books/RayTracingInOneWeekend.html#citingthisbook/snippets/html)

[16.2.3  LaTeX and BibTex](https://raytracing.github.io/books/RayTracingInOneWeekend.html#citingthisbook/snippets/latexandbibtex)

[16.2.4  BibLaTeX](https://raytracing.github.io/books/RayTracingInOneWeekend.html#citingthisbook/snippets/biblatex)

[16.2.5  IEEE](https://raytracing.github.io/books/RayTracingInOneWeekend.html#citingthisbook/snippets/ieee)

[16.2.6  MLA:](https://raytracing.github.io/books/RayTracingInOneWeekend.html#citingthisbook/snippets/mla:)
...
can find the finished source for each book in the [RayTracing project on GitHub](https://github.com/RayTracing/raytracing.github.io/).
...
check out the online [_Graphics Codex_](https://graphicscodex.com/) by Morgan McGuire, _Fundamentals of Computer_
_Graphics_ by Steve Marschner and Peter Shirley, or _Computer Graphics: Principles and Practice_
...
share your own ideas or work, see [the GitHub Discussions forum](https://github.com/RayTracing/raytracing.github.io/discussions/) on the GitHub project.

Thanks to everyone who lent a hand on this project. You can find them in the [acknowledgments](https://raytracing.github.io/books/RayTracingInOneWeekend.html#acknowledgments) section
...
[![](https://raytracing.github.io/images/fig-1.01-ppm.jpg)](https://raytracing.github.io/images/fig-1.01-ppm.jpg) **Figure 1:** PPM Example
...
[![](https://raytracing.github.io/images/img-1.01-first-ppm-image.png)](https://raytracing.github.io/images/img-1.01-first-ppm-image.png) Image 1: First PPM image
...
available on GitHub at [https://github.com/nothings/stb](https://github.com/nothings/stb).
...
a ray. Let’s think of a ray as a function P(t)=A+tbP(t)=A+tb. Here
PP is a 3D position along a line in 3D. AA is the ray origin and bb is
the ray direction. The ray parameter tt is a real number (`double` in the code). Plug in a
different tt and P(t)P(t) moves the point along the ray. Add in negative tt values and you
can go anywhere on the 3D line. For positive tt, you get only the parts in front of AA,
and this is what is often called a half-line or a ray.

[![](https://raytracing.github.io/images/fig-1.02-lerp.jpg)](https://raytracing.github.io/images/fig-1.02-lerp.jpg) **Figure 2:** Linear interpolation

We can represent the idea of a ray as a class, and represent the function P(t)P(t) as a
...
I’ve often gotten into trouble using square images for debugging because I transpose xx and yy too
...
For simplicity we'll start with the camera center at (0,0,0)(0,0,0). We'll also have the y-axis go up,
...
[![](https://raytracing.github.io/images/fig-1.03-cam-geom.jpg)](https://raytracing.github.io/images/fig-1.03-cam-geom.jpg) **Figure 3:** Camera geometry
...
As we scan our image, we will start at the upper left pixel (pixel 0,00,0), scan left-to-right across
each row, and then scan row-by-row, top-to-bottom. To help navigate the pixel grid, we'll use a
vector from the left edge to the right edge (VuVu), and a vector from the upper edge to
the lower edge (VvVv).
...
[![](https://raytracing.github.io/images/fig-1.04-pixel-grid.jpg)](https://raytracing.github.io/images/fig-1.04-pixel-grid.jpg) **Figure 4:** Viewport and pixel grid

In this figure, we have the viewport, the pixel grid for a 7×5 resolution image, the viewport
upper left corner QQ, the pixel P0,0P0,0 location, the viewport vector
VuVu (`viewport_u`), the viewport vector VvVv (`viewport_v`), and the pixel
delta vectors ΔuΔu and ΔvΔv.
...
linearly blend white and blue depending on the height of the yy coordinate _after_ scaling the ray
direction to unit length (so −1.0<y<1.0−1.0<y<1.0). Because we're looking at the yy height after
normalizing the vector, you'll notice a horizontal gradient to the color in addition to the vertical
gradient.

I'll use a standard graphics trick to linearly scale 0.0≤a≤1.00.0≤a≤1.0. When a=1.0a=1.0, I want blue.
When a=0.0a=0.0, I want white. In between, I want a blend. This forms a “linear blend”, or “linear
interpolation”. This is commonly referred to as a _lerp_ between two values. A lerp is always of the
form

blendedValue=(1−a)⋅startValue+a⋅endValue,blendedValue=(1−a)⋅startValue+a⋅endValue,

with aa going from zero to one.
...
[![](https://raytracing.github.io/images/img-1.02-blue-to-white.png)](https://raytracing.github.io/images/img-1.02-blue-to-white.png) Image 2: A blue-to-white gradient depending on ray Y coordinate
...
The equation for a sphere of radius rr that is centered at the origin is an important mathematical
equation:

x2+y2+z2=r2x2+y2+z2=r2

You can also think of this as saying that if a given point (x,y,z)(x,y,z) is on the surface of the
sphere, then x2+y2+z2=r2x2+y2+z2=r2. If a given point (x,y,z)(x,y,z) is _inside_ the sphere, then
x2+y2+z2<r2x2+y2+z2<r2, and if a given point (x,y,z)(x,y,z) is _outside_ the sphere, then
x2+y2+z2>r2x2+y2+z2>r2.

If we want to allow the sphere center to be at an arbitrary point (Cx,Cy,Cz)(Cx,Cy,Cz), then the
equation becomes a lot less nice:

(Cx−x)2+(Cy−y)2+(Cz−z)2=r2(Cx−x)2+(Cy−y)2+(Cz−z)2=r2

In graphics, you almost always want your formulas to be in terms of vectors so that all the
xx/yy/zz stuff can be simply represented using a `vec3` class. You might note that the vector
from point P=(x,y,z)P=(x,y,z) to center C=(Cx,Cy,Cz)C=(Cx,Cy,Cz) is
(C−P)(C−P).

If we use the definition of the dot product:

(C−P)⋅(C−P)=(Cx−x)2+(Cy−y)2+(Cz−z)2(C−P)⋅(C−P)=(Cx−x)2+(Cy−y)2+(Cz−z)2

Then we can rewrite the equation of the sphere in vector form as:

(C−P)⋅(C−P)=r2(C−P)⋅(C−P)=r2

We can read this as “any point PP that satisfies this equation is on the sphere”. We want
to know if our ray P(t)=Q+tdP(t)=Q+td ever hits the sphere anywhere. If it
does hit the sphere, there is some tt for which P(t)P(t) satisfies the sphere equation. So
we are looking for any tt where this is true:

(C−P(t))⋅(C−P(t))=r2(C−P(t))⋅(C−P(t))=r2

which can be found by replacing P(t)P(t) with its expanded form:

(C−(Q+td))⋅(C−(Q+td))=r2(C−(Q+td))⋅(C−(Q+td))=r2
...
we don't need to work that hard. If you remember, we want to solve for tt, so we'll separate the
terms based on whether there is a tt or not:

(−td+(C−Q))⋅(−td+(C−Q))=r2(−td+(C−Q))⋅(−td+(C−Q))=r2

And now we follow the rules of vector algebra to distribute the dot product:

t2d⋅d−2td⋅(C−Q)+(C−Q)⋅(C−Q)=r2t2d⋅d−2td⋅(C−Q)+(C−Q)⋅(C−Q)=r2

Move the square of the radius over to the left hand side:

t2d⋅d−2td⋅(C−Q)+(C−Q)⋅(C−Q)−r2=0t2d⋅d−2td⋅(C−Q)+(C−Q)⋅(C−Q)−r2=0

It's hard to make out what exactly this equation is, but the vectors and rr in that equation are
all constant and known. Furthermore, the only vectors that we have are reduced to scalars by dot
product. The only unknown is tt, and we have a t2t2, which means that this equation is quadratic.
You can solve for a quadratic equation ax2+bx+c=0ax2+bx+c=0 by using the quadratic formula:

−b±b2−4ac−−−−−−−√2a−b±b2−4ac2a

So solving for tt in the ray-sphere intersection equation gives us these values for aa, bb, and
cc:
...
c=(C−Q)⋅(C−Q)−r2c=(C−Q)⋅(C−Q)−r2

Using all of the above you can solve for tt, but there is a square root part that can be either
...
[![](https://raytracing.github.io/images/fig-1.05-ray-sphere.jpg)](https://raytracing.github.io/images/fig-1.05-ray-sphere.jpg) **Figure 5:** Ray-sphere intersection results
...
[![](https://raytracing.github.io/images/img-1.03-red-sphere.png)](https://raytracing.github.io/images/img-1.03-red-sphere.png) Image 3: A simple red sphere
...
solution exists, but solutions with negative values of tt work just fine. If you change your sphere
center to z=+1z=+1 you will get exactly the same picture because this solution doesn't distinguish
...
[![](https://raytracing.github.io/images/fig-1.06-sphere-normal.jpg)](https://raytracing.github.io/images/fig-1.06-sphere-normal.jpg) **Figure 6:** Sphere surface-normal geometry
...
easy and somewhat intuitive to assume nn is a unit length vector — so each component is
between −1 and 1) is to map each component to the interval from 0 to 1, and then map (x,y,z)(x,y,z) to
(red,green,blue)(red,green,blue). For the normal, we need the hit point, not just
whether we hit or not (which is all we're calculating at the moment). We only have one sphere in the
scene, and it's directly in front of the camera, so we won't worry about negative values of tt yet.
We'll just assume the closest hit point (smallest tt) is the one that we want. These changes in the
code let us compute and visualize nn:
...
[![](https://raytracing.github.io/images/img-1.04-normals-sphere.png)](https://raytracing.github.io/images/img-1.04-normals-sphere.png) Image 4: A sphere colored according to its normal vectors
...
the quadratic equation if b=−2hb=−2h:

−b±b2−4ac−−−−−−−√2a−b±b2−4ac2a

=−(−2h)±(−2h)2−4ac−−−−−−−−−−−√2a=−(−2h)±(−2h)2−4ac2a

=2h±2h2−ac−−−−−−√2a=2h±2h2−ac2a

=h±h2−ac−−−−−−√a=h±h2−aca

This simplifies nicely, so we'll use it. So solving for hh:

b=−2d⋅(C−Q)b=−2d⋅(C−Q)

b=−2hb=−2h

h=b−2=d⋅(C−Q)h=b−2=d⋅(C−Q)
...
found it convenient to add a valid interval for hits tmintmin to tmaxtmax, so
the hit only “counts” if tmin<t<tmaxtmin<t<tmax. For the initial rays this is
positive tt, but as we will see, it can simplify our code to have an interval tmintmin to
tmaxtmax. One design question is whether to do things like compute the normal if we hit
...
[![](https://raytracing.github.io/images/fig-1.07-normal-sides.jpg)](https://raytracing.github.io/images/fig-1.07-normal-sides.jpg) **Figure 7:** Possible directions for sphere surface-normal geometry
...
**Listing 19:** `[hittable.h]` Adding front-face tracking to hit\_record
...
**Listing 21:** `[hittable_list.h]` The hittable\_list class
...
**Listing 22:** An example allocation using shared\_ptr
...
**Listing 23:** An example allocation using shared\_ptr with auto type
...
Finally, the `using` statements in [listing 21](https://raytracing.github.io/books/RayTracingInOneWeekend.html#listing_hittable-list-initial) tell the compiler that we'll be
...
**Listing 27:** `[hittable_list.h]` Assume rtweekend.h inclusion for hittable\_list.h
...
[![](https://raytracing.github.io/images/img-1.05-normals-sphere-ground.png)](https://raytracing.github.io/images/img-1.05-normals-sphere-ground.png) Image 5: Resulting render of normals-colored sphere with ground
...
#include "color.h"#include "interval.h"
#include "ray.h"
#include "vec3.h"
```
...
class hittable_list : public hittable {
  public:
    ...    bool hit(const ray& r, interval ray_t, hit_record& rec) const override {
        ...
        for (const auto& object : objects) {            if (object->hit(r, interval(ray_t.min, closest_so_far), temp_rec)) {
                hit_anything = true;
                closest_so_far = temp_rec.t;
                rec = temp_rec;
            }
...
**Listing 34:** `[hittable_list.h]` hittable\_list::hit() using interval
...
class sphere : public hittable {
  public:
    ...    bool hit(const ray& r, interval ray_t, hit_record& rec) const override {
        ...
        // Find the nearest root that lies in the acceptable range.
        auto root = (h - sqrtd) / a;        if (!ray_t.surrounds(root)) {
            root = (h + sqrtd) / a;            if (!ray_t.surrounds(root))
                return false;
        }
        ...
    }
...
```
color ray_color(const ray& r, const hittable& world) {
    hit_record rec;    if (world.hit(r, interval(0, infinity), rec)) {
        return 0.5 * (rec.normal + color(1,1,1));
    }
...
With a single ray through the center of each pixel, we are performing what is commonly called _point_
_sampling_. The problem with point sampling can be illustrated by rendering a small checkerboard far
away. If this checkerboard consists of an 8×8 grid of black and white tiles, but only four
...
straight-forward. (See [_A Pixel is Not a Little Square_](https://www.researchgate.net/publication/244986797) for a deeper dive into this
topic.)

[![](https://raytracing.github.io/images/fig-1.08-pixel-samples.jpg)](https://raytracing.github.io/images/fig-1.08-pixel-samples.jpg) **Figure 8:** Pixel samples
...
return a canonical random number, which by convention falls in the range 0≤n<10≤n<1. The “less
...
```\
\
**Listing 41:** `[rtweekend.h]` random\_double() functions\
\
...
the proper \[0,1\]\[0,1\] bounds, we'll add and use a small helper function: `interval::clamp(x)`.\
\
```\
class interval {\
  public:\
...
\
    ...
    ...\
  private:\
    int    image_height;         // Rendered image height    double pixel_samples_scale;  // Color scale factor for a sum of pixel samples\
    point3 center;               // Camera center\
    point3 pixel00_loc;          // Location of pixel 0, 0\
    vec3   pixel_delta_u;        // Offset to pixel to the right\
    vec3   pixel_delta_v;        // Offset to pixel below\
...
\
[![](https://raytracing.github.io/images/img-1.06-antialias-before-after.png)](https://raytracing.github.io/images/img-1.06-antialias-before-after.png) Image 6: Before and after antialiasing\
\
\
# Diffuse Materials\
\
...
\
[![](https://raytracing.github.io/images/fig-1.09-light-bounce.jpg)](https://raytracing.github.io/images/fig-1.09-light-bounce.jpg) **Figure 9:** Light ray bounces\
\
...
\
[![](https://raytracing.github.io/images/fig-1.10-random-vec-horizon.jpg)](https://raytracing.github.io/images/fig-1.10-random-vec-horizon.jpg) **Figure 10:** Equal reflection above the horizon\
\
...
xx, yy, and zz are all in the range \[−1,+1\]\[−1,+1\]). If this point lies outside the unit\
sphere, then generate a new one until we find one that lies inside or on the unit sphere.\
\
[![](https://raytracing.github.io/images/fig-1.11-sphere-vec.jpg)](https://raytracing.github.io/images/fig-1.11-sphere-vec.jpg) **Figure 11:** Two vectors were rejected before finding a good one (pre-normalization)\
\
[![](https://raytracing.github.io/images/fig-1.12-sphere-unit-vec.jpg)](https://raytracing.github.io/images/fig-1.12-sphere-unit-vec.jpg) **Figure 12:** The accepted random vector is normalized to produce a unit vector\
\
...
```\
\
**Listing 48:** `[vec3.h]` The random\_unit\_vector() function, version one\
\
...
will be zero, and thus normalizing will yield the bogus vector \[±∞,±∞,±∞\]\[±∞,±∞,±∞\].\
To fix this, we'll also reject points that lie inside this “black hole” around the center. With\
double precision (64-bit floats), we can safely support values greater than 10−16010−160.\
\
...
inline vec3 random_unit_vector() {\
    while (true) {\
        auto p = vec3::random(-1,1);\
        auto lensq = p.length_squared();        if (1e-160 < lensq && lensq <= 1)\
            return p / sqrt(lensq);\
    }\
}\
```\
...
\
[![](https://raytracing.github.io/images/fig-1.13-surface-normal.jpg)](https://raytracing.github.io/images/fig-1.13-surface-normal.jpg) **Figure 13:** The normal vector tells us which hemisphere we need\
\
...
\
[![](https://raytracing.github.io/images/img-1.07-first-diffuse.png)](https://raytracing.github.io/images/img-1.07-first-diffuse.png) Image 7: First render of a diffuse sphere\
\
\
...
\
[![](https://raytracing.github.io/images/img-1.08-second-diffuse.png)](https://raytracing.github.io/images/img-1.08-second-diffuse.png) Image 8: Second render of a diffuse sphere with limited bounces\
\
\
## Fixing Shadow Acne\
\
...
t=0.00000001t=0.00000001 or whatever floating point approximation the hit function gives us. The simplest hack\
...
\
[![](https://raytracing.github.io/images/img-1.09-no-acne.png)](https://raytracing.github.io/images/img-1.09-no-acne.png) Image 9: Diffuse sphere with no shadow acne\
\
\
...
distribution. This distribution scatters reflected rays in a manner that is proportional to cos(ϕ)cos⁡(ϕ), where ϕϕ is the angle between the reflected ray and the surface normal. This means that\
...
intersection on a surface there is the hit point, pp, and there is the normal of the\
surface, nn. At the point of intersection, this surface has exactly two sides, so there\
...
\
One sphere will be displaced in the direction of the surface's normal (nn) and one sphere\
will be displaced in the opposite direction (−n−n). This leaves us with two spheres of unit\
size that will only be _just_ touching the surface at the intersection point. From this, one of the\
spheres will have its center at (P+n)(P+n) and the other sphere will have its\
center at (P−n)(P−n). The sphere with a center at (P−n)(P−n) is\
considered _inside_ the surface, whereas the sphere with center (P+n)(P+n) is\
...
Pick a random point SS on this unit radius sphere and send a ray from the hit point\
PP to the random point SS (this is the vector (S−P)(S−P)):\
\
[![](https://raytracing.github.io/images/fig-1.14-rand-unitvec.jpg)](https://raytracing.github.io/images/fig-1.14-rand-unitvec.jpg) **Figure 14:** Randomly generating a vector according to Lambertian distribution\
\
...
\
        hit_record rec;\
\
        if (world.hit(r, interval(0.001, infinity), rec)) {            vec3 direction = rec.normal + random_unit_vector();\
            return 0.5 * ray_color(ray(rec.p, direction), depth-1, world);\
        }\
\
        vec3 unit_direction = unit_vector(r.direction());\
...
```\
\
**Listing 55:** `[camera.h]` ray\_color() with replacement diffuse\
\
After rendering we get a similar image:\
\
[![](https://raytracing.github.io/images/img-1.10-correct-lambertian.png)](https://raytracing.github.io/images/img-1.10-correct-lambertian.png) Image 10: Correct rendering of Lambertian spheres\
\
\
...
\
[![](https://raytracing.github.io/images/img-1.11-linear-gamut.png)](https://raytracing.github.io/images/img-1.11-linear-gamut.png) Image 11: The gamut of our renderer so far\
\
...
exponent of 1/gamma1/gamma, which is just the square-root. We'll also want to ensure that we\
...
```\
\
**Listing 57:** `[color.h]` write\_color(), with gamma correction\
\
Using this gamma correction, we now get a much more consistent ramp from darkness to lightness:\
\
[![](https://raytracing.github.io/images/img-1.12-gamma-gamut.png)](https://raytracing.github.io/images/img-1.12-gamma-gamut.png) Image 12: The gamut of our renderer, gamma-corrected\
\
\
# Metal\
\
...
class hit_record {\
  public:\
    point3 p;\
    vec3 normal;    shared_ptr<material> mat;\
    double t;\
    bool front_face;\
\
    void set_face_normal(const ray& r, const vec3& outward_normal) {\
...
reflectance RR, or it can sometimes scatter (with probability 1−R1−R) with no attenuation (where a\
...
\
Note the third option: we could scatter with some fixed probability pp and have attenuation be\
albedo/palbedo/p. Your choice.\
\
...
\
[![](https://raytracing.github.io/images/fig-1.15-reflection.jpg)](https://raytracing.github.io/images/fig-1.15-reflection.jpg) **Figure 15:** Ray reflection\
\
The reflected ray direction in red is just v+2bv+2b. In our design, nn\
is a unit vector (length one), but vv may not be. To get the vector bb, we scale\
the normal vector by the length of the projection of vv onto nn, which is given\
by the dot product v⋅nv⋅n. (If nn were not a unit vector, we would\
also need to divide this dot product by the length of nn.) Finally, because vv\
points _into_ the surface, and we want bb to point _out_ of the surface, we need to negate\
...
#include "camera.h"\
#include "hittable.h"\
#include "hittable_list.h"#include "material.h"\
#include "sphere.h"\
\
int main() {\
    hittable_list world;\
...
Which gives:\
\
[![](https://raytracing.github.io/images/img-1.13-metal-shiny.png)](https://raytracing.github.io/images/img-1.13-metal-shiny.png) Image 13: Shiny metal\
\
\
## Fuzzy Reflection\
\
...
\
[![](https://raytracing.github.io/images/fig-1.16-reflect-fuzzy.jpg)](https://raytracing.github.io/images/fig-1.16-reflect-fuzzy.jpg) **Figure 16:** Generating fuzzed reflection rays\
\
...
\
    bool scatter(const ray& r_in, const hit_record& rec, color& attenuation, ray& scattered)\
    const override {\
        vec3 reflected = reflect(r_in.direction(), rec.normal);        reflected = unit_vector(reflected) + (fuzz * random_unit_vector());\
        scattered = ray(rec.p, reflected);\
...
\
[![](https://raytracing.github.io/images/img-1.14-metal-fuzz.png)](https://raytracing.github.io/images/img-1.14-metal-fuzz.png) Image 14: Fuzzed metal\
\
\
# Dielectrics\
\
...
\
[![](https://raytracing.github.io/images/img-1.15-glass-first.png)](https://raytracing.github.io/images/img-1.15-glass-first.png) Image 15: Glass first\
\
\
...
\
η⋅sinθ=η′⋅sinθ′η⋅sin⁡θ=η′⋅sin⁡θ′\
\
Where θθ and θ′θ′ are the angles from the normal, and ηη and η′η′ (pronounced\
“eta” and “eta prime”) are the refractive indices. The geometry is:\
\
[![](https://raytracing.github.io/images/fig-1.17-refraction.jpg)](https://raytracing.github.io/images/fig-1.17-refraction.jpg) **Figure 17:** Ray refraction\
\
In order to determine the direction of the refracted ray, we have to solve for sinθ′sin⁡θ′:\
\
sinθ′=ηη′⋅sinθsin⁡θ′=ηη′⋅sin⁡θ\
\
On the refracted side of the surface there is a refracted ray R′R′ and a normal\
n′n′, and there exists an angle, θ′θ′, between them. We can split R′R′ into\
the parts of the ray that are perpendicular to n′n′ and parallel to n′n′:\
\
R′=R′⊥+R′∥R′=R′⊥+R′∥\
\
If we solve for R′⊥R′⊥ and R′∥R′∥ we get:\
\
R′⊥=ηη′(R+\|R\|cos(θ)n)R′⊥=ηη′(R+\|R\|cos⁡(θ)n)\
\
R′∥=−1−\|R′⊥\|2−−−−−−−−√nR′∥=−1−\|R′⊥\|2n\
\
...
\
We know the value of every term on the right-hand side except for cosθcos⁡θ. It is well known\
...
\
If we restrict aa and bb to be unit vectors:\
\
a⋅b=cosθa⋅b=cos⁡θ\
\
We can now rewrite R′⊥R′⊥ in terms of known quantities:\
\
R′⊥=ηη′(R+(−R⋅n)n)R′⊥=ηη′(R+(−R⋅n)n)\
\
When we combine them back together, we can write a function to calculate R′R′:\
\
```\
...\
\
...
\
[![](https://raytracing.github.io/images/img-1.16-glass-always-refract.png)](https://raytracing.github.io/images/img-1.16-glass-always-refract.png) Image 16: Glass sphere that always refracts\
\
\
...
Snell's law and the derivation of sinθ′sin⁡θ′:\
\
sinθ′=ηη′⋅sinθsin⁡θ′=ηη′⋅sin⁡θ\
\
If the ray is inside glass and outside is air (η=1.5η=1.5 and η′=1.0η′=1.0):\
\
sinθ′=1.51.0⋅sinθsin⁡θ′=1.51.0⋅sin⁡θ\
\
The value of sinθ′sin⁡θ′ cannot be greater than 1. So, if,\
\
1.51.0⋅sinθ>1.01.51.0⋅sin⁡θ>1.0\
\
...
\
index of refraction of airindex of refraction of waterindex of refraction of airindex of refraction of water\
\
```\
auto material_ground = make_shared<lambertian>(color(0.8, 0.8, 0.0));\
auto material_center = make_shared<lambertian>(color(0.1, 0.2, 0.5));auto material_left   = make_shared<dielectric>(1.00 / 1.33);\
auto material_right  = make_shared<metal>(color(0.8, 0.6, 0.2), 1.0);\
```\
\
...
\
[![](https://raytracing.github.io/images/img-1.17-air-bubble-total-reflection.png)](https://raytracing.github.io/images/img-1.17-air-bubble-total-reflection.png) Image 17: Air bubble sometimes refracts, sometimes reflects\
\
\
...
world.add(make_shared<sphere>(point3( 0.0, -100.5, -1.0), 100.0, material_ground));\
world.add(make_shared<sphere>(point3( 0.0,    0.0, -1.2),   0.5, material_center));\
world.add(make_shared<sphere>(point3(-1.0,    0.0, -1.0),   0.5, material_left));world.add(make_shared<sphere>(point3(-1.0,    0.0, -1.0),   0.4, material_bubble));\
world.add(make_shared<sphere>(point3( 1.0,    0.0, -1.0),   0.5, material_right));\
...\
```\
\
...
\
[![](https://raytracing.github.io/images/img-1.18-glass-hollow.png)](https://raytracing.github.io/images/img-1.18-glass-hollow.png) Image 18: A hollow glass sphere\
\
\
# Positionable Camera\
\
...
\
First, we'll keep the rays coming from the origin and heading to the z=−1z=−1 plane. We could make\
it the z=−2z=−2 plane, or whatever, as long as we made hh a ratio to that distance. Here is our\
setup:\
\
[![](https://raytracing.github.io/images/fig-1.18-cam-view-geom.jpg)](https://raytracing.github.io/images/fig-1.18-cam-view-geom.jpg) **Figure 18:** Camera viewing geometry (from the side)\
\
This implies h=tan(θ2)h=tan⁡(θ2). Our camera now becomes:\
\
```\
class camera {\
  public:\
...
\
[![](https://raytracing.github.io/images/img-1.19-wide-view.png)](https://raytracing.github.io/images/img-1.19-wide-view.png) Image 19: A wide-angle view\
\
\
...
\
[![](https://raytracing.github.io/images/fig-1.19-cam-view-dir.jpg)](https://raytracing.github.io/images/fig-1.19-cam-view-dir.jpg) **Figure 19:** Camera view direction\
\
...
and vector normalizations, we now have a complete orthonormal basis (u,v,w)(u,v,w) to describe our\
camera’s orientation. uu will be the unit vector pointing to camera right, vv is the unit vector\
pointing to camera up, ww is the unit vector pointing opposite the view direction (since we use\
right-hand coordinates), and the camera center is at the origin.\
\
[![](https://raytracing.github.io/images/fig-1.20-cam-view-up.jpg)](https://raytracing.github.io/images/fig-1.20-cam-view-up.jpg) **Figure 20:** Camera view up direction\
\
Like before, when our fixed camera faced −Z−Z, our arbitrary view camera faces −w−w. Keep in mind\
that we can — but we don’t have to — use world up (0,1,0)(0,1,0) to specify vup. This is convenient and\
...
\
        center = lookfrom;\
\
        // Determine viewport dimensions.        auto focal_length = (lookfrom - lookat).length();\
...
\
        ...
        pixel_delta_v = viewport_v / image_height;\
\
        // Calculate the location of the upper left pixel.        auto viewport_upper_left = center - (focal_length * w) - viewport_u/2 - viewport_v/2;\
        pixel00_loc = viewport_upper_left + 0.5 * (pixel_delta_u + pixel_delta_v);\
    }\
\
    ...\
...
to get:\
\
[![](https://raytracing.github.io/images/img-1.20-view-distant.png)](https://raytracing.github.io/images/img-1.20-view-distant.png) Image 20: A distant view\
\
\
...
to get:\
\
[![](https://raytracing.github.io/images/img-1.21-view-zoom.png)](https://raytracing.github.io/images/img-1.21-view-zoom.png) Image 21: Zooming in\
\
# Defocus Blur\
\
...
\
[![](https://raytracing.github.io/images/fig-1.21-cam-lens.jpg)](https://raytracing.github.io/images/fig-1.21-cam-lens.jpg) **Figure 21:** Camera lens model\
\
...
\
\
[![](https://raytracing.github.io/images/fig-1.22-cam-film-plane.jpg)](https://raytracing.github.io/images/fig-1.22-cam-film-plane.jpg) **Figure 22:** Camera focus plane\
\
...
\
        // Determine viewport dimensions.        auto focal_length = (lookfrom - lookat).length();\
        auto theta = degrees_to_radians(vfov);\
        auto h = std::tan(theta/2);        auto viewport_height = 2 * h * focus_dist;\
        auto viewport_width = viewport_height * (double(image_width)/image_height);\
\
        // Calculate the u,v,w unit basis vectors for the camera coordinate frame.\
        w = unit_vector(lookfrom - lookat);\
...
\
        ...
        pixel_delta_v = viewport_v / image_height;\
\
        // Calculate the location of the upper left pixel.        auto viewport_upper_left = center - (focus_dist * w) - viewport_u/2 - viewport_v/2;\
        pixel00_loc = viewport_upper_left + 0.5 * (pixel_delta_u + pixel_delta_v);\
\
...
We get:\
\
[![](https://raytracing.github.io/images/img-1.22-depth-of-field.png)](https://raytracing.github.io/images/img-1.22-depth-of-field.png) Image 22: Spheres with depth-of-field\
\
\
# Where Next?\
\
...
This gives:\
\
[![](https://raytracing.github.io/images/img-1.23-book1-final.jpg)](https://raytracing.github.io/images/img-1.23-book1-final.jpg) Image 23: Final scene\
\
...
\
**Parallelism** — Run NN copies of your code on NN cores with different random seeds. Average the\
NN runs. This averaging can also be done hierarchically where N/2N/2 pairs can be averaged to get\
N/4N/4 images, and pairs of those can be averaged. That method of parallelism should extend well into\
...
- **URL (book)**: [https://raytracing.github.io/books/raytracinginoneweekend.html](https://raytracing.github.io/books/raytracinginoneweekend.html)\
\
## Snippets\
\
### Markdown\
